              ...
              <Card className="bg-[#1a1a1a] border-[#333333]">
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="h-6 w-32 bg-gray-700 animate-pulse mb-1"></div>
                    <div className="h-4 w-24 bg-gray-700 animate-pulse mb-4"></div>
                    <div className="h-4 w-full bg-gray-700 animate-pulse mb-4"></div>
